...
define config.name = _("Sabby Dreams")
...
define gui.about = _p("""
Девочка страдает от снов, которые кажутся настолько реалистичными, что ей кажется, что она вот-вот умрет. Впадает в кому в свой день рождения, но что происходит дальше вам предстоит узнать, окунувшись в нашу игру.
...
define config.save_directory = "SabbyDreams-1682527905"
